...
fasthistoriescpp <- function(mm, nc, cc, grain, ncores, safeLL, binomN, indiv, w, ki, gk, hk, density, PIA, Tsk, mask_indices, mask_offsets, mask_id) {
    .Call(`_secr_fasthistoriescpp`, mm, nc, cc, grain, ncores, safeLL, binomN, indiv, w, ki, gk, hk, density, PIA, Tsk, mask_indices, mask_offsets, mask_id)
}

signalhistoriescpp <- function(mm, nc, detectfn, grain, ncores, safeLL, binomN, w, signal, group, gk, gsbval, dist2, density, PIA, miscparm, mask_indices, mask_offsets, mask_id) {

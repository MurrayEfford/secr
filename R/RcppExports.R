...
ykpointcpp <- function(D, dist2, detect, Tsk, markocc, fn, gsb, miscparm, w2, binomN, grain, ncores) {
    .Call('_secr_ykpointcpp', PACKAGE = 'secr', D, dist2, detect, Tsk, markocc, fn, gsb, miscparm, w2, binomN, grain, ncores)
}

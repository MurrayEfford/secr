...
This document provides a compact overview of **secr** 5.2, an R package for spatially explicit capture--recapture analysis (SECR).  For background on SECR and a tutorial see the SECR book, [Efford (2025)].  

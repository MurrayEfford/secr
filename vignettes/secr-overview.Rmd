---
title: '**secr** 5.5 - spatially explicit capture--recapture in R'
...
These are the core functions of **secr** 5.5 -- the ones that you are most likely to use. S3 methods are marked with an asterisk.
